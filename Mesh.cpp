...
//
//        //glEnableVertexAttribArray(3);
//        //glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, 12 * sizeof(float), (void*)(6 * sizeof(float))); //colorMask
//
...
//}
//
//void Mesh::createMesh(vector<float>& verts, vector<unsigned int>& inds) {
